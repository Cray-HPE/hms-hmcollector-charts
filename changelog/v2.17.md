...
- Updated HMCOLLECTOR to point to latest SMD v2.45.0 image
...
- Update alpine image to 3.22
- Update k8s_api_checker version to v4
- Internal tracking ticket: CASMHMS-6610
